                                        ...
                                        <div class="schedule-item border rounded p-3 mb-3">
                                            <div class="row">
                                                <div class="col-12 mb-2">
                                                    <label for="schedule_{{ $index }}_day_of_week" class="form-label">Día de la Semana</label>
                                                    <select id="schedule_{{ $index }}_day_of_week" name="schedules[{{ $index }}][day_of_week]" class="form-control form-control-sm">
                                                ...
                                                <div class="col-6 mb-2">
                                                    <label for="schedule_{{ $index }}_start_time" class="form-label">Hora Inicio</label>
                                                    <input type="time"
                                                           id="schedule_{{ $index }}_start_time"
                                                           name="schedules[{{ $index }}][start_time]"
                                                           class="form-control form-control-sm"
                                                           value="{{ $schedule->start_time ? \Carbon\Carbon::parse($schedule->start_time)->format('H:i') : '' }}">
                                                </div>
                                                <div class="col-6 mb-2">
                                                    <label for="schedule_{{ $index }}_end_time" class="form-label">Hora Fin</label>
                                                    <input type="time"
                                                           id="schedule_{{ $index }}_end_time"
                                                           name="schedules[{{ $index }}][end_time]"
                                                           class="form-control form-control-sm"
                                                           value="{{ $schedule->end_time ? \Carbon\Carbon::parse($schedule->end_time)->format('H:i') : '' }}">
                                                </div>
                                                <div class="col-6 mb-2">
                                                    <label for="schedule_{{ $index }}_start_date" class="form-label">Fecha Inicio</label>
                                                    <input type="date"
                                                           id="schedule_{{ $index }}_start_date"
                                                           name="schedules[{{ $index }}][start_date]"
                                                           class="form-control form-control-sm"
                                                           value="{{ $schedule->start_date ? $schedule->start_date->format('Y-m-d') : '' }}">
                                                </div>
                                                <div class="col-6 mb-2">
                                                    <label for="schedule_{{ $index }}_end_date" class="form-label">Fecha Fin</label>
                                                    <input type="date"
                                                           id="schedule_{{ $index }}_end_date"
                                                ...
                                                <div class="col-12">
                                                    <div class="form-check form-check-inline">
                                                        <input type="checkbox"
                                                               id="schedule_{{ $index }}_is_recurring"
                                                               name="schedules[{{ $index }}][is_recurring]"
                                                               class="form-check-input"
                                                               {{ $schedule->is_recurring ? 'checked' : '' }}>
                                                        <label for="schedule_{{ $index }}_is_recurring" class="form-check-label">Recurrente</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input type="checkbox"
        ...
        addScheduleBtn.addEventListener('click', function(e) {
            ...
            const scheduleHtml = `
                <div class="schedule-item border rounded p-3 mb-3" style="background-color: #f8f9fa;">
                    <div class="row">
                        <div class="col-12 mb-2">
                            <label for="new_schedule_${scheduleIndex}_day_of_week" class="form-label"><strong>Día de la Semana</strong></label>
                            <select id="new_schedule_${scheduleIndex}_day_of_week" name="schedules[${scheduleIndex}][day_of_week]" class="form-control form-control-sm" required>
                        ...
                        <div class="col-6 mb-2">
                            <label for="new_schedule_${scheduleIndex}_start_time" class="form-label"><strong>Hora Inicio</strong></label>
                            <input type="time"
                                   id="new_schedule_${scheduleIndex}_start_time"
                                   name="schedules[${scheduleIndex}][start_time]"
                                   class="form-control form-control-sm"
                                   required>
                        </div>
                        <div class="col-6 mb-2">
                            <label for="new_schedule_${scheduleIndex}_end_time" class="form-label"><strong>Hora Fin</strong></label>
                            <input type="time"
                                   id="new_schedule_${scheduleIndex}_end_time"
                                   name="schedules[${scheduleIndex}][end_time]"
                                   class="form-control form-control-sm"
                                   required>
                        </div>
                        <div class="col-6 mb-2">
                            <label for="new_schedule_${scheduleIndex}_start_date" class="form-label">Fecha Inicio</label>
                            <input type="date"
                                   id="new_schedule_${scheduleIndex}_start_date"
                                   name="schedules[${scheduleIndex}][start_date]"
                                   class="form-control form-control-sm"
                                   value="${currentDate}">
                        </div>
                        <div class="col-6 mb-2">
                            <label for="new_schedule_${scheduleIndex}_end_date" class="form-label">Fecha Fin (opcional)</label>
                            <input type="date"
                                   id="new_schedule_${scheduleIndex}_end_date"
