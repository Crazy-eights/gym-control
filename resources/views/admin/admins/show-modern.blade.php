    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ route('admin.admins.index') }}" class="text-success">Administradores</a>
                </li>
        ...
        <div class="col-lg-4">
            <div class="content-section text-center h-100">
                ...
                @if($admin->id === auth('admin')->id())
                    <span class="badge badge-modern badge-success mb-3">Tu cuenta</span>
                @endif

                @if($admin->id !== auth('admin')->id())
                    <button type="button" class="btn btn-danger btn-modern w-100"
                ...
                <div class="mt-3 text-muted small">
                    <i class="fas fa-envelope me-1 text-success"></i>{{ $admin->email }}
                </div>
            </div>
        </div>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        <div class="info-group">
                            ...
                            <p class="info-value">{{ $admin->firstname }}</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="info-group">
                            <span class="info-label">Apellido</span>
                            <p class="info-value">{{ $admin->lastname }}</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="info-group">
                            <span class="info-label">Usuario</span>
                            <p class="info-value">{{ $admin->username }}</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="info-group">
                            ...
                            <p class="info-value">
                                <a href="mailto:{{ $admin->email }}" class="text-success">
                                    {{ $admin->email }}
                                </a>
                            </p>
                        </div>
        ...
        <div class="modal-content shadow-lg border-0">
            ...
            <div class="modal-body p-3">
                ...
                <p class="text-center mb-2">
                    ...
                    <strong id="adminName" class="text-danger"></strong>?
                </p>
