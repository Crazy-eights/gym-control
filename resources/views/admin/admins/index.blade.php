    ...
    <div class="content-section">
                        ...
                        <td>
                            <div class="action-buttons">
                                ...
                                <button type="button" 
                                        ...
                                        title="Editar"
                                        onclick="editAdmin({{ $admin->id }}, '{{ e($admin->firstname) }}', '{{ e($admin->lastname) }}', '{{ e($admin->username) }}', '{{ e($admin->email) }}')">
                                ...
                                <button type="button" 
                                        ...
                                        title="Eliminar"
                                        onclick="confirmDelete({{ $admin->id }}, '{{ e($admin->username) }}')">
        ...
        <div class="d-flex justify-content-between align-items-center mt-4">
            <div class="text-muted">
                Mostrando {{ $admins->firstItem() }} a {{ $admins->lastItem() }} de {{ $admins->total() }} administradores
            </div>
            <div>
                {{ $admins->links() }}
            </div>
                ...
                <div class="modal-body p-3">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control form-control-sm" id="create_firstname" name="firstname" placeholder="Nombre" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="create_lastname" class="form-label fw-semibold">Apellido <span class="text-danger">*</span></label>
                            <input type="text" class="form-control form-control-sm" id="create_lastname" name="lastname" placeholder="Apellido" required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control form-control-sm" id="create_username" name="username" placeholder="usuario123" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="email" class="form-control form-control-sm" id="create_email" name="email" placeholder="admin@gimnasio.com" required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="password" class="form-control form-control-sm" id="create_password" name="password" placeholder="Mínimo 6 caracteres" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="password" class="form-control form-control-sm" id="create_password_confirmation" name="password_confirmation" placeholder="Repetir contraseña" required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-0">
                            ...
                            <input type="file" class="form-control form-control-sm" id="create_photo" name="photo" accept="image/*">
                ...
                <div class="modal-body p-3">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control form-control-sm" id="edit_firstname" name="firstname" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="edit_lastname" class="form-label fw-semibold">Apellido <span class="text-danger">*</span></label>
                            <input type="text" class="form-control form-control-sm" id="edit_lastname" name="lastname" required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="password" class="form-control form-control-sm" id="edit_password" name="password" placeholder="Dejar en blanco para mantener actual">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="password" class="form-control form-control-sm" id="edit_password_confirmation" name="password_confirmation" placeholder="Repetir nueva contraseña">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-0">
                            ...
                            <input type="file" class="form-control form-control-sm" id="edit_photo" name="photo" accept="image/*">
                            <small class="form-text text-muted">Opcional. Formatos: JPG, PNG, GIF. Máximo 2MB</small>
                        </div>
                    </div>
                </div>
